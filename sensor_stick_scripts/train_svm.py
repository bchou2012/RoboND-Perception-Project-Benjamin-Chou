...
training_set = pickle.load(open('training_set_1.sav', 'rb'))#filename format training_set_[no].sav
...
# Create classifier, default kernel'linear', other options 'poly', 'rbf', 'sigmoid'
#dataset_1, linear best results
...
pickle.dump(model, open('model_1.sav', 'wb'))#format model_[no].sav
